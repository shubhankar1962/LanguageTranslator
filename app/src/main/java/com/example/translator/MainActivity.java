...
public class MainActivity extends AppCompatActivity {
    ...
    //created this array to store items for spinner
    String[] fromLanguage={"from","English","Africans","Arabic","Belarusian","Bulgarian","Bengali","Catalan","Czech","Welsh","Hindi","urdu"};

    String[] toLanguage={"To","English","Africans","Arabic","Belarusian","Bulgarian","Bengali","Catalan","Czech","Welsh","Hindi","urdu"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sourceEdit = findViewById(R.id.edit_textid);
        micIv = findViewById(R.id.image_mic);
